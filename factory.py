...
class Factory(object, metaclass=ABCMeta):
	...
	- External Usage documentation: U{https://github.com/tylerlaberfe/PyPatterns/wiki/Creational-Pattern-Usage}

	- External Factory Pattern documenttation: U{https://e,.wikipedia.org/wiki/Factory_method_pattern}
	"""
...
class AbstractFactory(Factory, metaclass=ABCMeta):
	"""
	Abstract Factory Class as part of the AbstractFactory desgin pattern.

	- External Usage documentation: U{https://github.com/tyleraberge/PyPatterns/wiki/Creational-Pattern-Usage}
	- External Abstract Factory Pattern documenttation: U{https://en.wikipedia.org/wiki/Abstract_factory_pattern}
	"""
	def __init__(self):
		"""
		...
		are register all their factories to keys using the register method.
		"""
